...
<html>
	...
	<body style="overflow-x:hidden; overflow-y:scroll;">
		<header>
			...
			<div class="logoutdiv">
				<%=session.getAttribute("loginname")%>(님) <a href="<%= request.getContextPath() %>/Common/logout.do">로그아웃</a><img src="<%= request.getContextPath() %>/webimage/notice.png" style="width:10%; height:10%;">
			</div>
			<!-- header top hr -->
