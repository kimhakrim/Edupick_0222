			...
			<article>
				<form class="cladmain">
					<ul id="main1">
						<li>수강명 : <input ></li>
						<li>수강비 : <input ></li>
						<li>수강기간 : 시작일 : <input type="date" > 종료일 : <input type="date" > 상시<input type="checkbox" ></li>
						<li>모집기간 : 시작일 : <input type="date" > 종료일 : <input type="date" > 상시<input type="checkbox" ></li>
						<li>수강시간 : <input type="time" > ~ <input type="time" ></li>
						<li>모집인원 : <input type="number" > <input type="checkbox" > 제한없음</li>
					</ul>
					<ul id="main2">
						<li>강의교재 : <input ></li>
						<li>강의시간 : <input type="time" > ~ <input type="time" ></li>
						<li>강의목표 : <input ></li>
						<li>강사이력 : <input ></li>
					</ul>
