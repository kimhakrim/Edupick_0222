...
<html>
	<head>
		...
		<link href="학원찾기.css" rel="stylesheet" type="text/css" />
		<script src="학원찾기.js"></script>
	</head>
	<body style="overflow-x:hidden; overflow-y:scroll;"> 
		<header>
			...
			<div class="headerimg">
				<a href="에듀픽.html">
				<img class="img1" src="edupick2.jpg">	
				</a>
			</div>
			<div class="logoutdiv">
				○○○(님) <a href="#">로그아웃</a><img src="알림.png" style="width:10%; height:10%;">
			</div>
			<!-- 검색 폼 -->
			<form class="frmsh">
				<!-- 검색박스 -->
				<div class="search01">
					...
					<button type="button" id="btn01"><img id="img4" src="search.jpg" ></button>
				</div>
				<!-- 연령 -->
				<div class="agemain">
					<h3>연령</h3>
			...
			<div id="topmenumain">
				<ul>
					<li>
						<a href="학원찾기.html" class="menua" style="background:#FA5858">학원찾기</a>
					</li>
					<li>
						<a href="공지사항.html" class="menua">공지사항</a>
					</li>
					<li>
						<a href="교육정보.html" class="menua">교육정보</a>
					</li>
					<li>
						<a href="고객센터.html" class="menua">고객센터</a>
					</li>
					<li>
						<a href="My서비스.html" class="menua">My 서비스</a>
					</li>
				</ul>
			</div>
		</header>
